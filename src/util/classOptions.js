...
export const sizeOptions = {
    ...
    normal: 'min-w-24 max-w-28',
    wide: 'min-w-80 max-w-96',
...
export const loadingOptions = {
    ...
    "three-quarter-dark": 'inline-block after:content-[" "] after:block after:size-6 after:border-dark after:border-b-transparent after:border-[4px] after:rounded-[50%] after:border-solid after:animate-spin'
};