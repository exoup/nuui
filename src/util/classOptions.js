...
export const surfaceColorOptions = {
    primary: 'bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700',
    secondary: 'bg-secondary-50 dark:bg-gray-900 border border-light dark:border-dark',
    tertiary: 'bg-white dark:bg-tertiary-text border border-tertiary-200 dark:border-tertiary',
    neutral: 'bg-neutral-50 dark:bg-neutral-900 border border-neutral-700 dark:border-neutral-800'
};

export const childSurfaceColorOptions = {
    primary: 'bg-gray-50 border-t-gray-200 dark:bg-gray-700/30 dark:border-t-white/5 dark:shadow-gray-800',
